...
<div class="container">
	...
	<ul class="pagination">
		<c:choose>
			<c:when test="${startPageNum ne 1 }">
				<li>
					<a href="list.do?pageNum=${startPageNum-1 }&condition=${condition}&keyword=${keyword}">&laquo;</a><!-- 눌렀을 때 1씩 작아지도록 -->
				</li>
			</c:when>
			<c:otherwise>
				<li class="disabled">
		...
		<c:forEach var="i" begin="${startPageNum }"
			end="${endPageNum }"><!-- begin - 시작숫자 / end - 마지막숫자 -->
			<c:choose>
	...
	<form action="list.do" method="post">
		...
		<!-- condition, keyword(titlecontent,title,writer 셋 중 하나)가 parameter 로 전달된다. -->
	</form>
	<c:choose>
