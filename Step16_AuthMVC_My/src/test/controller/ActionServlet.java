...
public class ActionServlet extends HttpServlet{
	//. 을 포함한 요청 확장자의 길이
	public static final int INCLUDE_EXTENSION_LENGTH=3;//.do 의 길이 / @WebServlet의 길이에 따라 수정하기
	...
	protected void service(HttpServletRequest request, 
		...
		//순수 요청 경로를 추출 한다.
		// command => /fortune or /info or /signin or /signout / (member/list or /member/insert...)
